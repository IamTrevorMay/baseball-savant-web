/**
 * Shared MCP server instance with all tool registrations.
 * Imported by both stdio (index.ts) and HTTP (http.ts) entry points.
 */
...
export function createTritonServer(): McpServer {
