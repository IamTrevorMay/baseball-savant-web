...
import type { MovementConfig as MovementConfigType } from '@/lib/producerTypes'

interface Props {
  onChange: (config: MovementConfigType | null) => void
}

export default function MovementConfig({ onChange }: Props) {
