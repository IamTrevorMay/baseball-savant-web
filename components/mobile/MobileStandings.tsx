...
export default function MobileStandings({ standings }: Props) {
  const {
      ...
      <div className="px-4 py-4">
        ...
        {standingsLoading ? (
          <div className="flex justify-center py-16">
            <div className="w-8 h-8 border-3 border-zinc-700 border-t-emerald-500 rounded-full animate-spin" />
          </div>
        ) : view === 'division' ? (
...
function MobileDivision({ division, expanded, onToggle }: { division: Division; expanded: boolean; onToggle: () => void }) {
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-lg mb-2 overflow-hidden">
      ...
      {/* Always show compact W-L-PCT-GB */}
