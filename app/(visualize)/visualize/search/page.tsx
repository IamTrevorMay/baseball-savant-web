...
export default function VisualizeSearchPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-white tracking-tight">Search a Player</h1>
        <p className="text-sm text-zinc-500 mt-1">Select a pitcher to browse visualization templates</p>
      </div>
