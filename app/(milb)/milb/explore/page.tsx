...
export default function MilbExplorePage() {
  ...
  useEffect(() => {
    async function loadOptions() {
      ...
      // MiLB AAA team abbreviations
      o.home_team = ['ABQ','BUF','CLT','COL','DUR','ELP','GWN','IND','IOW','JAX','LHV','LOU','LV','MEM','NAS','NOR','OKC','OMA','RNO','ROC','RR','SAC','SL','STP','SUG','SWB','SYR','TAC','TOL','WOR']
      o.away_team = ['ABQ','BUF','CLT','COL','DUR','ELP','GWN','IND','IOW','JAX','LHV','LOU','LV','MEM','NAS','NOR','OKC','OMA','RNO','ROC','RR','SAC','SL','STP','SUG','SWB','SYR','TAC','TOL','WOR']

      // Only query DISTINCT for columns that genuinely vary (events, descriptions, alignments, years)
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      if (DEFENCE_STAT_SETS.has(statSet)) {
        ...
        // Standard report API — MiLB endpoint
        ...
        const res = await fetch('/api/milb/report', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            metrics,
