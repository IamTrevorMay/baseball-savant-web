...
export default function PitchersPage() {
  ...
  async function loadDbInfo() {
    ...
    setDbInfo({ total: row?.total || 0, pitchers: 0, lastDate: row?.lastDate || '' })
  }
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-200">
      {/* Nav */}
      <ResearchNav active="/pitchers" rightContent={<span className="text-[11px] text-zinc-600 font-mono">{dbInfo.total.toLocaleString()} pitches</span>} />
