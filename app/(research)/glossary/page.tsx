...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { name: 'Missfire', description: 'Average distance (inches) that outside-zone pitches miss the strike zone by. Only pitches outside the zone are included. Lower is better — means misses stay closer to the zone edge.', formula: 'avg(abs(brink)) for outside-zone pitches, in inches' },
      { name: 'Close%', description: 'Percentage of zone misses that land within 2 inches of the strike zone edge. Higher is better — means a greater proportion of misses stay near the zone.', formula: 'count(outside-zone pitches within 2" of edge) / count(outside-zone pitches) × 100' },
