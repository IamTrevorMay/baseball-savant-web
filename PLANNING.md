...
**Monitoring gap this exposed:** nothing alerts on `max(downloaded_at)` going stale. A dead-man check on the archive (no successful download in 48h → alert) would have caught this on day two instead of day 35.
